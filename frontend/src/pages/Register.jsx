...
import { User, Mail, Lock, Phone, Home, DollarSign, ArrowRight, Eye, EyeOff, UtensilsCrossed, Sparkles } from 'lucide-react';

// Import your SVG
import messAnimation from '../assets/register.svg';
...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 relative overflow-hidden">
            ...
            <div className="absolute top-10 left-10 text-5xl animate-float-slow opacity-30">🥄</div>
            <div className="absolute top-20 right-20 text-6xl animate-float-medium opacity-25">👨‍🍳</div>
            <div className="absolute bottom-20 left-20 text-5xl animate-float-fast opacity-30">🍴</div>
            <div className="absolute bottom-32 right-32 text-5xl animate-float-slow-delay opacity-25">🔪</div>
            <div className="absolute top-1/3 left-5 text-4xl animate-float-medium-delay opacity-20">🍲</div>
            <div className="absolute bottom-1/3 right-5 text-4xl animate-float-fast-delay opacity-20">🍽️</div>
            <div className="absolute top-1/2 left-1/4 text-3xl animate-float-slow opacity-15">🧂</div>
            <div className="absolute top-1/3 right-1/4 text-3xl animate-float-medium opacity-15">🌶️</div>
            <div className="absolute bottom-1/4 left-1/3 text-4xl animate-float-fast opacity-20">🥖</div>
            <div className="absolute top-1/4 left-1/2 text-4xl animate-float-slow-delay opacity-15">🥄</div>
            <div className="absolute bottom-10 left-1/2 text-4xl animate-float-medium opacity-15">🍞</div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <User className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-red-700" />
                                <input
                                    type="text"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type="email"
                                        className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <Phone className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-red-700" />
                                    <input
                                        type="tel"
                                        className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                                ...
                                {errors.phone && <p className="text-xs text-rose-300 mt-1">{errors.phone}</p>}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="relative">
                                    <Home className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-red-700" />
                                    <input
                                        type="text"
                                        className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <DollarSign className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-red-700" />
                                    <input
                                        type="number"
                                        step="0.01"
                                        required
                                ...
                                {errors.individual_rent && <p className="text-xs text-rose-300 mt-1">{errors.individual_rent}</p>}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-12 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                            ...
                            <div>
                                ...
                                {errors.confirmPassword && <p className="text-xs text-rose-300 mt-1">{errors.confirmPassword}</p>}
                            </div>
                        </div>
